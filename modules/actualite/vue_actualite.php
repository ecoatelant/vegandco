...
?>
    ...
    public function afficherActualite($actualites)
    {
                ...
                <section>
                    <article class="debut-actualite">
                        <div class="img-actualite">
                            <img src="<?= PATHBASE ?>/data/img_actualite/<?php echo $actualite['image'] ?>" alt="image du groupe des Gaïennes">
                            <div class="overlay">
                        ...
                        <div class="pres-actualite">
                            ...
                            <div class="date-auteur">
                                <p>Posté le <strong><?php echo $actualite['date'] ?></strong></p>
                                <p>Écrit par <strong><?php echo $actualite['auteur'] ?></strong></p>
                            </div>
                        </div>
                    </article>
