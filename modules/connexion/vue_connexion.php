            ...
            <section>
                <article>
                    <div class="image-slot">
                        <picture>
                            <source srcset="../media/inscription_mob.jpg" media="(max-width: 1023px)">
                            <img src="../media/inscription_desktop.jpg" alt="visuel téléphone avec des légumes autour">
                        </picture>
                    </div>
                    <div class="signup">
                        <h1>Inscription</h1>
        ...
        <main class="inscription vege">
            <section>
                <article>
                    <div class="image-slot">
                        <picture>
                            <source srcset="../media/inscription/inter_mob.jpg" media="(max-width: 1023px)">
                            <img src="../media/inscription/inter_desk.jpg" alt="visuel téléphone avec des légumes autour" />
                        </picture>
                    </div>
                    <div class="signup">
                        ...
                        <div class="fsignup">
                            <form class="codepromo" action="" method="post">
                                ...
                                <div class="cta-row">
                                    <button class="yes cta" type="submit">Oui</button>
                                    <button class="no cta" type="submit">Non</button>
                                </div>
                            </form>
                        </div>
                    </div>
                        ...
                        <div class="fsignup">
                            <form class="codepromo" action="" method="post">
                                <div>
                                    ...
                                    <input type="date" id="dateReduit" name="dateReduit" placeholder="" required>
                                </div>
                                <div>
                                    <button class="registerbtn cta" type="submit">Valider</button>
                                </div>
        ...
        <main class="inscription vege">
            <section>
                <article>
                    <div class="image-slot">
                        <picture>
                            <source srcset="../media/inscription/newsletter_mob.jpg" media="(max-width: 1023px)">
                            <img src="../media/inscription/newsletter_desk.jpg" alt="visuel téléphone avec des légumes autour" />
                        </picture>
                    </div>
                    <div class="signup">
                        <h1>Newsletter</h1>
